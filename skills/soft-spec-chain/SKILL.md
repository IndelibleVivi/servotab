---
name: soft-spec-chain
description: "Preserve an approved specification through a complete implementation plan and execution. Use for major refactors, migrations, or multi-session work when a confirmed spec is the authority; cover the whole spec and make scope or order changes explicit. Avoid for ordinary work without an approved spec."
---
...
- Present consumer and goal provenance when the specification proposes a generalized protocol, new infrastructure, or a programme reorder
