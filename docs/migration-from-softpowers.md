...
This guide moves an active, manifest-owned Softpowers `0.3.0-rc5` or earlier global-skill layer to the Servotab `0.4.0-rc1` plugin package without manually deleting installed skills or rewriting legacy manifests.
...
Expected candidate version: `0.4.0-rc1`. Do not continue from an unknown generated tree or stale manifest.
...
- It does not submit or publish Servotab in the OpenAI plugin directory.
