...
This guide moves an active, manifest-owned Softpowers `0.3.0-rc5` or earlier global-skill layer to the tagged Servotab `0.6.3` plugin package without manually deleting installed skills or rewriting legacy manifests.
...
Expected release version: `0.6.3`. Do not continue from an unknown generated tree or stale manifest.
