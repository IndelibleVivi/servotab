...
GitHub publication does not establish installation, activation, website deployment, OpenAI directory update or live model effectiveness. At this checkpoint the official directory listing and production website remain recorded at 0.6.3; the 0.6.4 directory upload is a separate owner action. No live target-model attempt or improvement claim is established.
